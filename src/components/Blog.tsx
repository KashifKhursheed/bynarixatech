            ...
            >
              <div>
                <div className="relative h-44 overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-slate-900/90 dark:bg-blue-600 text-white">
                      {post.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5 space-y-2.5">
                  <div className="flex items-center gap-3 text-[11px] text-black dark:text-slate-400 font-mono font-bold">
                  ...
                  <h3 className="text-base font-bold text-black dark:text-white line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-cyan-400 transition-colors">
                    {post.title}
                  </h3>

                  <p className="text-xs text-black dark:text-slate-400 line-clamp-2 leading-relaxed font-medium">
                    {post.excerpt}
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 pt-0">
                <button
                  ...
                  className="w-full inline-flex items-center justify-between py-2 px-3 rounded-lg bg-slate-100 dark:bg-slate-800 text-black dark:text-slate-100 hover:bg-slate-900 hover:text-white dark:hover:bg-[#00E5FF] dark:hover:text-slate-950 transition-all text-xs font-bold border border-slate-200 dark:border-slate-700"
                >
            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="flex items-center gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-black/80 dark:text-slate-400 font-medium">{selectedPost.author.role}</div>
                </div>
                <div className="ml-auto text-xs font-mono text-black dark:text-slate-400 font-bold">
                  {selectedPost.date} ({selectedPost.readTime})
                </div>
              </div>

              {/* Body */}
              <div className="text-xs sm:text-sm text-black dark:text-slate-300 space-y-4 leading-relaxed font-medium">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-xs text-black dark:text-slate-400 font-bold">Need help implementing these tech architectures?</span>
                <button
                  onClick={() => {
