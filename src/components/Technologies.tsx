      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200/80 dark:border-blue-800/80 text-black dark:text-cyan-300 text-xs font-mono font-bold uppercase tracking-wider">
            <CpuIcon className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-emerald-100 dark:bg-emerald-950/60 text-black dark:text-emerald-300 font-bold">
                      {tech.level}
                    </span>
                  </div>

                  <h3 className="text-sm font-bold text-black dark:text-white mb-1 group-hover:text-blue-600 dark:group-hover:text-cyan-400 transition-colors">
                    {tech.name}
                  </h3>
                  <p className="text-[11px] text-black dark:text-slate-400 leading-relaxed font-medium">
                    {tech.description}
                  </p>
                </div>

                <div className="mt-4 pt-2 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-[10px] text-black dark:text-slate-400 font-bold">
