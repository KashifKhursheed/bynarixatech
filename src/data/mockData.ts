...
export const SERVICES_DATA: ServiceItem[] = [
  ...
  {
    id: 'pwa-dev',
    title: 'Modern Web Apps & Portals',
    category: 'web',
    iconName: 'Globe',
    shortDesc: 'High-speed, responsive, and offline-capable web applications delivering desktop-grade performance.',
    fullDesc: 'Bridge the gap between web and native software. Our modern web applications deliver instant page loads via smart caching, background sync, installability, and lightning-fast responsiveness.',
    features: ['Offline-First Functionality', 'Push Notification Engine', 'Lighthouse Score 95+ Guarantee', 'Zero-Install Fast Experience'],
    techStack: ['React', 'Next.js', 'TypeScript', 'Web Push API', 'IndexedDB'],
    deliverables: ['Web App Deployment', 'Lighthouse Audit Report', 'Modern Web Manifest', 'Cross-Browser Suite'],
  },
  {
    id: 'custom-web',
