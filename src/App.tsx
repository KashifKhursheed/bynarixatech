...
export default function App() {
  ...
  return (
    <ThemeProvider>
      <PWAProvider>
        <div className="min-h-screen bg-[#F8F7FF] dark:bg-[#09090F] text-[#11111A] dark:text-[#F8F7FF] transition-colors duration-300 selection:bg-[#7C3AED] selection:text-white relative overflow-hidden">
